...
export class ChangeRepositoryImpl implements ChangeRepository {
    ...
    private mapChangeRealmToEntity(doc: ChangeRealm): Change {
        return new Change({
            ...
            before: doc.before,
            beforeDetails: {
                start: doc.beforeDetails.start,
                end: doc.beforeDetails.end,
                contextBefore: doc.beforeDetails.contextBefore,
                contextAfter: doc.beforeDetails.contextAfter,
            },
            after: doc.after,
            afterDetails: {
                start: doc.afterDetails.start,
                end: doc.afterDetails.end,
                contextBefore: doc.afterDetails.contextBefore,
                contextAfter: doc.afterDetails.contextAfter,
            },
